<template>
	<div class="home container">
		<div class="i-dont-actually-use-css-like-this">
            <h1>The Name's Preston | <sub>Wild Beard</sub></h1>
        
            <p>You'll notice this is really bland. Not much of a designer. I am, however, really good at recreating what I can see in code.</p>
            
            <p>Am I looking for a job? <strong>Nope!</strong> But I bought this domain and I really needed to do something with it other than host Minecraft servers.</p>
        </div> <!-- !.i-dont-actually-use-css-like-this -->
        
        <div class="i-made-some-money">
            ...
            <ul>
                ...
                <li>
                    <strong><a href="https://softball.org" target="_blank" class="asa">Amateur Softball Associate</a>:</strong> <span class="fancy">Developer | 2013 - 2015</span><br>
                    Android App, .Net, ASP, PHP. Build an <a href="https://www.usasoftballstore.com/" target="_blank" class="asa">eCommerce platform</a> from scratch, support a <a href="https://www.registerusasoftball.com" target="_blank" class="asa">registration system</a> used by 300k+ users annually, video subscriptions and testing for coaching certification, WCWC Bracket Challenge hosted on ESPN? Done.
                </li>
                <li>
                    <strong>AWOL:</strong> <span class="fancy">2011 - 2013</span><br>
                    I did some freelance, odd jobs, drove cars, did construction for a day.
                </li>
                <li>
                    <strong><a href="https://advancedacademics.com/" target="_blank" class="adv">Advanced Academnics</a>:</strong> <span class="fancy">Conversion Specialist | 2011 - 2011</span><br>
                    Basically went back to school and remade a large bulk of the course material in 508 Compliance for hearing and visually impared students. If it matters I was 18 and a teamleader.
                </li>
            </ul>
        </div> <!-- !.i-made-some-money -->
        
        <div class="a-container container">
            
            <div class="row">
				<div class="what-i-will-do-for-love col-6">
					<h2>What I Do</h2>
					<ul>
