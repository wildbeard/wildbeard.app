<template>
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-wrap -mx-4 px-4">
      <div class="w-full mb-4 md:w-1/4 md:order-2 md:mb-0">
        ...
        <div class="flex justify-center mb-4">
          <span
            ...
            :key="tag"
            class="mr-2 py-1 px-1.5 text-xs bg-slate-600 rounded hover:cursor-pointer"
      ...
      <div class="w-full md:w-3/4 md:order-1">
        ...
        <article
          ...
          v-else
          :key="post.id"
          class="md:max-w-lg mb-4">
          <div
            class="relative group pb-4 border-b border-b-logo hover:cursor-pointer md:border-b-transparent">
            <h3>
            ...
            <div class="flex flex-wrap items-center">
              ...
              <div v-if="post.tags.length" class="ml-4">
                <span
